<template>
    <div>
      ...
      <el-table :data="tableData" height="800" border style="width: 100%">
        <el-table-column prop="基金代码" label="代码" width="180"> </el-table-column>
        <el-table-column prop="基金简称" label="名称"> </el-table-column>
        <el-table-column prop="基金类型" label="基金类型">
        </el-table-column>
        <el-table-column prop="基金经理" label="基金经理"> </el-table-column>
        <el-table-column prop="集中认购期" label="集中认购期"> </el-table-column>
        <el-table-column prop="成立来涨幅" label="成立来涨幅"> </el-table-column>
        <el-table-column prop="发行公司" label="发行公司"> </el-table-column>
